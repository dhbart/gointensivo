...
func TestGivenAnEmptyID_WhenCreateANewOrder_ThenShouldReceiveANewError(t *testing.T) {
	/*order, err := NewOrder("", 100, 10)
	if err == nil {
...
func TestGivenAnEmptyPrice_WhenCreateANewOrder_ThenShouldReceiveANewError(t *testing.T) {

	order := Order{ID: "123"}
	assert.Error(t, order.IsValid(), "invalid price")
}

func TestGivenAnEmptyTax_WhenCreateANewOrder_ThenShouldReceiveANewError(t *testing.T) {
